...
#endif /* defined(ADC_theACLK__CFG3) */

#define ADC_theACLK_Enable()                       ADC_theACLK_Start()
#define ADC_theACLK_Disable()                      ADC_theACLK_Stop()
#define ADC_theACLK_SetDivider(clkDivider)         ADC_theACLK_SetDividerRegister(clkDivider, 1u)
#define ADC_theACLK_SetDividerValue(clkDivider)    ADC_theACLK_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define ADC_theACLK_SetPhaseValue(clkPhase)        ADC_theACLK_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(ADC_theACLK__CFG3) */
