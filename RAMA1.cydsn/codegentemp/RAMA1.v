...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("422ca7e3-b36c-4604-8b5d-7562532018b6/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("4e138636-3477-4a1d-a4d6-927d8f2e8d16/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__LM35_net;
	wire [0:0] tmpFB_0__LM35_net;
	wire [0:0] tmpIO_0__LM35_net;
	wire [0:0] tmpINTERRUPT_0__LM35_net;
	electrical [0:0] tmpSIOVREF__LM35_net;
	...
	cy_psoc3_pins_v1_10
		...
		LM35
		 (.oe(tmpOE__LM35_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LM35_net[0:0]}),
		  .analog({Net_2}),
		  .io({tmpIO_0__LM35_net[0:0]}),
		  .siovref(tmpSIOVREF__LM35_net),
		  .interrupt({tmpINTERRUPT_0__LM35_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LM35_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [2:0] tmpOE__SWI_net;
	wire [2:0] tmpFB_2__SWI_net;
	wire [2:0] tmpIO_2__SWI_net;
	...
	cy_psoc3_pins_v1_10
		...
		SWI
		 (.oe(tmpOE__SWI_net),
		  .y({3'b0}),
		  .fb({tmpFB_2__SWI_net[2:0]}),
		  .io({tmpIO_2__SWI_net[2:0]}),
		  .siovref(tmpSIOVREF__SWI_net),
		  .interrupt({Net_11}),
		  .annotation({Net_14, Net_19, Net_10}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SWI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};
